...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        UnitOfMeasure dashUomOptional = unitOfMeasureRepository.findByDescription("Dash")
                .orElseThrow(() -> new RuntimeException(EXPECTED_UOM_NOT_FOUND));
        ...
        guacNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix" +
                ...
                " seeds and chunks of peaches in it (a Diana Kennedy favorite). Try guacamole with added pineapple," +
        ...
        tacosRecipe.setDirections("1 Prepare a gas or charcoal grill for medium-high, direct heat.\n" +
                ...
                "inserted into the thickest part of the meat registers 165F. Transfer to a " +
        ...
        tacoNotes.setRecipeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
                ...
                " I can always sniff out a late-night snacker " +
                "when the aroma of tortillas heating in a hot pan on the stove comes wafting through the house.\n" +
                "Today’s tacos are more purposeful – a deliberate meal instead of a secretive midnight snack!\n" +
                "First, I marinate the chicken briefly in a spicy paste of ancho chile powder, " +
                "oregano, cumin, and sweet orange juice while the grill is heating. " +
